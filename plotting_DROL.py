...
def show_tensor_np(a: torch.Tensor, fig_num=None, title=None):  # xyl 20220927
    """Display a 2D tensor.
    args:
        fig_num: Figure number.
        title: Title of figure.
    ...
    if title is not None:
        plt.title(title)
    # plt.savefig('/home/xyl/xyl-code/siamban-DROL/classification.png', pad_inches=0, dpi=300)
    plt.draw()
    plt.pause(0.001)
